...
impl object NativeMath {
	...
	impl fun acos(v: Double): Double = java.lang.Math.acos(v)
	impl fun asin(v: Double): Double = java.lang.Math.asin(v)
	impl fun atan(v: Double): Double = java.lang.Math.atan(v)
	impl fun atan2(y: Double, x: Double): Double = java.lang.Math.atan2(y, x)
